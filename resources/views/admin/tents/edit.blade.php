            ...
            <form method="POST" action="/admin/tents/{{ $tent->id }}/update" class="space-y-8" enctype="multipart/form-data">
                    ...
                    <div class="p-8 space-y-8">
                        <div class="grid grid-cols-1 gap-8">
                            ...
                            <div>
                                        ...
                                        @foreach ($tent->images as $image)
                                            <div class="relative group rounded-lg overflow-hidden shadow-sm">
                                                ...
                                                <label class="absolute inset-0 cursor-pointer">
                                                    ...
                                                    <div
                                                        class="absolute inset-0 bg-black/0 group-hover:bg-black/60 peer-checked:bg-black/40 transition-all duration-200 flex items-center justify-center">
                                                        <div
                                                            class="text-white opacity-0 group-hover:opacity-100 peer-checked:opacity-100 flex flex-col items-center transition-opacity duration-200">
                                                            <div
                                                                class="bg-red-600 p-2 rounded-full mb-2 peer-checked:block hidden">
                                                            ...
                                                            <div
                                                                class="bg-white/20 p-2 rounded-full mb-2 peer-checked:hidden block">
                                                                <svg class="w-6 h-6" fill="none"
                                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                                        stroke-width="2"
                                                            ...
                                                            <span
                                                                class="text-xs font-bold uppercase tracking-wider">Mark
                                                                for Delete</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- Selected Border -->
                                                    <div
                                                        class="absolute inset-0 border-4 border-red-500 rounded-lg pointer-events-none opacity-0 peer-checked:opacity-100 transition-opacity duration-200">
                                                    </div>
                                                </label>
                                            </div>
                                        @endforeach
                                    </div>
                                    <p class="text-xs text-gray-500 mb-6 italic">* Click trash icon to mark images for
                                        removal upon save.</p>
                                @elseif($tent->image)
                                ...
                                <div
                                    class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-green-500 hover:bg-green-50/30 transition-all duration-200 group cursor-pointer relative">
                                    <div class="space-y-1 text-center pointer-events-none">
                                        ...
                                        <div class="flex text-sm text-gray-600 justify-center">
                                            <span
                                                class="relative bg-white rounded-md font-medium text-green-600 hover:text-green-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-green-500">
                                    ...
                                    <input id="new_images" name="new_images[]" type="file"
                                        class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" multiple>
                                </div>

                                <div id="image-preview-container"
                                    class="mt-6 hidden grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    <label for="name" class="block text-sm font-bold text-gray-700">Tent Name <span
                                            class="text-red-500">*</span></label>
                                    <input type="text" name="name" id="name" required
                                        value="{{ old('name', $tent->name) }}"
                                ...
                                <div>
                                    <label for="min_capacity" class="block text-sm font-bold text-gray-700">Min
                                        Capacity <span class="text-red-500">*</span></label>
                                    <input type="number" name="min_capacity" id="min_capacity" required
                                        min="1" value="{{ old('min_capacity', $tent->min_capacity) }}"
                                        class="mt-2 block w-full shadow-sm sm:text-sm border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500 py-3 px-4">
                                </div>

                                <div>
                                    <label for="max_capacity" class="block text-sm font-bold text-gray-700">Max
                                        Capacity <span class="text-red-500">*</span></label>
                                    <input type="number" name="max_capacity" id="max_capacity" required
                                        min="1" value="{{ old('max_capacity', $tent->max_capacity) }}"
                                        class="mt-2 block w-full shadow-sm sm:text-sm border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500 py-3 px-4">
                                </div>
                            </div>
                            ...
                            <div class="border-t border-gray-100 pt-6">
                                <label for="pricing_type" class="block text-sm font-bold text-gray-700 mb-2">Pricing
                                    Structure <span class="text-red-500">*</span></label>
                                <select id="pricing_type" name="pricing_type" required
                                    class="block w-full pl-3 pr-10 py-3 text-base border-gray-300 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm rounded-lg border">
                                    <option value="" disabled>Select Pricing Type</option>
                                    <option value="person"
                                        {{ old('pricing_type', $tent->pricing_type) == 'person' ? 'selected' : '' }}>
                                        Per Person (Adult/Child rates)</option>
                                    <option value="base"
                                        {{ old('pricing_type', $tent->pricing_type) == 'base' ? 'selected' : '' }}>Base
                                        Price (Tiered by capacity)</option>
                                </select>
                            </div>

                            <!-- Base Price Fields -->
                            <div id="base-price-fields"
                                class="space-y-6 {{ old('pricing_type', $tent->pricing_type) == 'base' ? '' : 'hidden' }} bg-gray-50 rounded-xl p-6 border border-gray-200">
                                <div class="flex items-center justify-between mb-2">
                                    <h4 class="text-sm font-bold text-gray-900 uppercase tracking-wide">Capacity Tiers
                                    </h4>
                                    <span class="text-xs text-gray-500">Define price based on number of
                                        occupants</span>
                                </div>
                                ...
                                <div id="base-prices-container" class="space-y-4">
                                    ...
                                    @if (old('pricing_type', $tent->pricing_type) == 'base' && count($basePrices) > 0)
                                        @foreach ($basePrices as $index => $price)
                                            <div
                                                class="base-price-row bg-white border border-gray-200 p-5 rounded-xl relative shadow-sm transition-shadow hover:shadow-md">
                                                <div
                                                    class="absolute -left-3 top-4 bg-gray-800 text-white text-xs font-bold px-2 py-1 rounded shadow-sm">
                                                    Tier {{ $index + 1 }}</div>
                                                @if ($index > 0)
                                                    <button type="button"
                                                        class="remove-tier-btn absolute top-2 right-2 text-red-400 hover:text-red-700 text-sm font-medium transition-colors">
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mt-2">
                                                    ...
                                                    <div class="md:col-span-4">
                                                        <label
                                                            class="block text-xs font-bold text-gray-500 uppercase mb-1">Capacity</label>
                                                        <input type="number"
                                                            name="base_prices[{{ $index }}][capacity]"
                                                            min="1"
                                                            value="{{ $price['capacity'] ?? ($price->capacity ?? '') }}"
                                                            class="pl-2 block w-full shadow-sm sm:text-sm border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500 @error('base_prices.' . $index . '.capacity') border-red-500 @enderror"
                                                            placeholder="People">
                                                        @error('base_prices.' . $index . '.capacity')
                                                            <p class="mt-1 text-xs text-red-600 font-medium">
                                                                {{ $message }}</p>
                                                        @else
                                                            <p class="mt-1 text-xs text-gray-400">Max people for this price
                                                            </p>
                                                        @enderror
                                                    </div>
                                                    <input type="hidden" name="base_prices[{{ $index }}][id]"
                                                        value="{{ $price['id'] ?? ($price->id ?? '') }}">
                                                    <!-- Prices -->
                                                    <div class="md:col-span-4">
                                                        <label
                                                            class="block text-xs font-bold text-gray-500 uppercase mb-1">Weekday
                                                            ($)</label>
                                                        <div class="relative rounded-md shadow-sm">
                                                            ...
                                                            <input type="number"
                                                                name="base_prices[{{ $index }}][price_weekday]"
                                                                min="0" step="0.01"
                                                                value="{{ $price['price_weekday'] ?? ($price->price_weekday ?? '') }}"
                                                    ...
                                                    <div class="md:col-span-4">
                                                        <label
                                                            class="block text-xs font-bold text-gray-500 uppercase mb-1">Weekend
                                                            ($)</label>
                                                        <div class="relative rounded-md shadow-sm">
                                                            <div
                                                                class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                                            ...
                                                            <input type="number"
                                                                name="base_prices[{{ $index }}][price_weekend]"
                                                                min="0" step="0.01"
                                                                value="{{ $price['price_weekend'] ?? ($price->price_weekend ?? '') }}"
                                        ...
                                        <div
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mt-2">
                                                <div class="md:col-span-4">
                                                    <label
                                                        class="block text-xs font-bold text-gray-500 uppercase mb-1">Capacity</label>
                                                    <input type="number" name="base_prices[0][capacity]"
                                                        min="1" required
                                                        class="block w-full shadow-sm sm:text-sm border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500"
                                                        placeholder="People">
                                                </div>
                                                <div class="md:col-span-4">
                                                    <label
                                                    ...
                                                    <div class="relative rounded-md shadow-sm">
                                                        ...
                                                        <input type="number" name="base_prices[0][price_weekday]"
                                                ...
                                                <div class="md:col-span-4">
                                                    ...
                                                    <div class="relative rounded-md shadow-sm">
                                                        ...
                                                        <input type="number" name="base_prices[0][price_weekend]"
                                                            min="0" step="0.01" required
                                                            class="block w-full pl-7 shadow-sm sm:text-sm border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500"
                                                            placeholder="0.00">
                                                    </div>
                                ...
                                <button type="button" id="add-tier-btn"
                                    class="w-full inline-flex items-center justify-center px-4 py-2 border-2 border-dashed border-green-300 text-sm font-bold rounded-lg text-green-700 bg-green-50 hover:bg-green-100 hover:border-green-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all">
                            ...
                            <div id="additional-rates-fields"
                                class="{{ old('pricing_type', $tent->pricing_type) == 'person' || old('pricing_type', $tent->pricing_type) == 'base' ? '' : 'hidden' }} bg-gray-50 rounded-xl p-6 border border-gray-200">
                                <h4 id="rates-title"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    @php
                                        ...
                                        $adultPrice =
                                            $tent->pricing_type == 'person' && $firstPrice
                                                ? $firstPrice->adult_price
                                                : '';
                                        $childPrice = $firstPrice ? $firstPrice->child_price : '';
                                    @endphp
                                    <div id="adult-price-container"
                                        class="{{ old('pricing_type', $tent->pricing_type) == 'base' ? 'hidden' : '' }}">
                                        <label for="adult_price" class="block text-sm font-medium text-gray-700">Adult
                                            Price</label>
                                        <div class="relative mt-1 rounded-md shadow-sm">
                                            ...
                                            <input type="number" name="adult_price" id="adult_price" min="0"
                                                step="0.01" value="{{ old('adult_price', $adultPrice) }}"
                                    ...
                                    <div id="child-price-container">
                                        <label for="child_price" class="block text-sm font-medium text-gray-700">Child
                                            Price <span
                                                class="pricing-context-label text-xs font-normal text-gray-400">
                                        ...
                                        <div class="relative mt-1 rounded-md shadow-sm">
                                            ...
                                            <input type="number" name="child_price" id="child_price" min="0"
                                                step="0.01" value="{{ old('child_price', $childPrice) }}"
                                                class="block w-full pl-8 py-3 shadow-sm sm:text-lg border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500"
                                                placeholder="0.00">
                                        </div>
                                    </div>
                ...
                <div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100">
                    <div class="px-8 py-6 border-b border-gray-100 bg-gray-50/50">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Manage individual tent slots with unique identifiers</p>
                    </div>
                    ...
                    <div class="p-8 space-y-6">
                        <div id="slots-container" class="space-y-4">
                            ...
                            @if (count($slots) > 0)
                                @foreach ($slots as $index => $slot)
                                    <div
                                        class="slot-row bg-gray-50 border border-gray-200 p-5 rounded-xl relative shadow-sm transition-shadow hover:shadow-md">
                                        <div
                                        ...
                                        <div class="grid grid-cols-1 gap-4 mt-2">
                                            <div>
                                                ...
                                                @error('slots.' . $index . '.tent_number')
                                                    <p class="mt-1 text-xs text-red-600 font-medium">{{ $message }}
                                                    </p>
                                                @else
                                                    <p class="mt-1 text-xs text-gray-400">Unique identifier for this tent
                                                        slot</p>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid grid-cols-1 gap-4 mt-2">
                                        <div>
                                            <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Tent
                                                Number / Identifier</label>
                                            <input type="text" name="slots[0][tent_number]"
                                                class="block w-full shadow-sm sm:text-sm border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                                                placeholder="e.g., A1, B2, Tent-001">
                                            <p class="mt-1 text-xs text-gray-400">Unique identifier for this tent slot
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <button type="button" id="add-slot-btn"
                            class="w-full inline-flex items-center justify-center px-4 py-2 border-2 border-dashed border-blue-300 text-sm font-bold rounded-lg text-blue-700 bg-blue-50 hover:bg-blue-100 hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all">
                ...
                <div class="flex items-center justify-between pb-8">
                    ...
                    <button type="button"
                        onclick="if(confirm('Are you definitely sure? This will delete the tent and all its images permanently.')) document.getElementById('delete-form').submit();"
                        class="text-red-600 hover:text-red-900 font-medium text-sm flex items-center px-4 py-2 rounded-lg hover:bg-red-50 transition-colors">
                        <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16">
                            </path>
                    ...
                    <div class="flex space-x-4">
                        ...
                        <button type="submit"
                            class="inline-flex justify-center py-3 px-6 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-transform transform hover:-translate-y-0.5">
                            Update Changes
                        </button>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
                ...
                if (this.files && this.files.length > 0) {
                    ...
                    Array.from(this.files).forEach(file => {
                        ...
                        reader.onload = function(e) {
                            ...
                            img.className =
                                'h-32 w-full object-cover rounded-lg border border-gray-200 shadow-sm';
        ...
        addTierBtn.addEventListener('click', function() {
            ...
            newRow.className =
                'base-price-row bg-white border border-gray-200 p-5 rounded-xl relative shadow-sm transition-shadow hover:shadow-md mt-4';
            newRow.innerHTML = `
        ...
        addSlotBtn.addEventListener('click', function() {
            ...
            newSlot.className =
                'slot-row bg-gray-50 border border-gray-200 p-5 rounded-xl relative shadow-sm transition-shadow hover:shadow-md mt-4';
            newSlot.innerHTML = `
